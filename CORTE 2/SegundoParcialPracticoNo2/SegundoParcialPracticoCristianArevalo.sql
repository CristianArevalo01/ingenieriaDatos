...
/*(1)*/
-- a) agregar a la tabla pacientes una columna telefono
 alter table pacientes add column telefono varchar(15) null;
describe pacientes;
-- b) agregar a la tabla medicos una columna consultorio
 alter table medicos add column consultorio varchar(10) not null default "A1";
 describe medicos;
 -- c) indice unico sobre el campo email de la tabla pacientes
/*Ya existe el campo email como unique en la definición*/

-- d) elimine la columna activo de la tabla medicos
